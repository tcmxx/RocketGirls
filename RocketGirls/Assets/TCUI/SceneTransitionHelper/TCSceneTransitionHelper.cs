...
namespace TCUtils
{
    ...
    [Header("Settings")]
        ...
        public bool autoFadoueInNewScene = true;    //when false, the new sene will keep black until you call "AllowFade"
                    ...
                    StartCoroutine(StartLevelLoading(transitionSceneName, null,
                        () => {
                            ...
                            StartLevelLoading(sceneName,
                                ...
                                () =>
                                {
                                    if (!autoFadoueInNewScene)
                                        maskUI.enabled = false;
